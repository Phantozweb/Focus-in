...
const teamMembers = [
  ...
  },
  {
    ...
    description: 'I lead our audio learning platform, Focus Cast, ensuring students have access to high-quality, on-the-go educational content.',
    linkedinUrl: 'https://www.linkedin.com/company/focusprojects/',
    instagramUrl: 'https://www.instagram.com/focus_.in?igsh=dTY5MG96cHc5Zmhu',
  },
  {
    name: 'Akukalia Chinenyenwa Helen',
    title: 'Managing Director, Focus Links',
    description: 'I manage the development of our Focus Links project, ensuring students have access to a centralized hub of the best online resources.',
    linkedinUrl: 'https://www.linkedin.com/company/focusprojects/',
    instagramUrl: 'https://www.instagram.com/focus_.in?igsh=dTY5MG96cHc5Zmhu',
  },
  {
